...
public class Enemy_3 : Enemy { // Enemy_3 also extends the Enemy class
    ...
    void Start() {
        ...
        // Pick xMin and xMax the same way that Main.SpawnEnemy() does
    ...
    public override void Move() {
        ...
        pos = Utils.Bezier(u, points); // d
    }

    void DrawDebug() {
        // Draw the three points
        Debug.DrawLine(points[0], points[1], Color.cyan, lifeTime); // f
        Debug.DrawLine(points[1], points[2], Color.yellow, lifeTime); // f
        ...
        for (int i = 1; i <= numSections; i++) {
            ...
            col = Color.Lerp(Color.cyan, Color.yellow, u); // h
