...
[RequireComponent(typeof(EnemyShield))]  // Enemy_4 also extends the Enemy class
public class Enemy_4 : Enemy {
    [Header("Enemy_4 Inscribed Fields")]
    public float duration = 4;  // Duration of interpolation movement

    private EnemyShield[] allShields;  // Array of EnemyShield components
    private EnemyShield thisShield;    // Reference to this Enemy's EnemyShield
