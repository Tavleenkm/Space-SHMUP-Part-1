...
public class Weapon : MonoBehaviour {
    ...
    void Start() {
        ...
        // Check for child transforms to assign shotPointTrans
    ...
    //         Debug.LogError("No projectilePrefab assigned in WeaponDefinition for " + _type);
    //         return null;
    //     }
    ...
    //     } else {
    //         Debug.LogError("Shot point transform is missing");
    //     }
    ...
    Vector3 pos = shotPointTrans.position;
    pos.z = 0;  // Set Z to zero for visibility
